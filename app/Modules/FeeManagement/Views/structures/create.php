<?php
// File: app/Modules/FeeManagement/Views/structures/create.php
// Included by layout_admin.php

// $pageTitle, $sessions, $categories, $classes, $errors, $oldInput, $viewError passed
?>

<h1><?php echo isset($pageTitle) ? htmlspecialchars($pageTitle) : 'Create Fee Structure'; ?></h1>
...
<form action="/sfms_project/public/admin/fees/structures" method="POST">
    <?php  // CSRF Token ?>
            ...
            <div class="col-md-6 mb-3">
                ...
                <select id="category_id" name="category_id" required class="form-select <?php echo isset($errors['category_id']) ? 'is-invalid' : ''; ?>">
                    <option value="">-- Select Category --</option>
                     <?php foreach ($categories ?? [] as $id => $name): ?>
                        <option value="<?php echo $id; ?>" <?php echo (isset($oldInput['category_id']) && $oldInput['category_id'] == $id) ? 'selected' : ''; ?>>
                            <?php echo htmlspecialchars($name); ?>
                        </option>
                    <?php endforeach; ?>
                </select>
             ...
             <div class="col-md-12 mb-3">
                ...
                <input type="text" id="structure_name" name="structure_name" required maxlength="150"
                       placeholder="e.g., Grade 1 Tuition Fee 2024-2025"
                       value="<?php echo htmlspecialchars($oldInput['structure_name'] ?? ''); ?>"
                ...
                <select id="applicable_class_id" name="applicable_class_id" class="form-select <?php echo isset($errors['applicable_class_id']) ? 'is-invalid' : ''; ?>">
                    <option value="">-- All Classes --</option>
                     <?php foreach ($classes ?? [] as $id => $name): ?>
                        <option value="<?php echo $id; ?>" <?php echo (isset($oldInput['applicable_class_id']) && $oldInput['applicable_class_id'] == $id) ? 'selected' : ''; ?>>
                            <?php echo htmlspecialchars($name); ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="col-md-6 mb-3">
             ...
             <div class="col-md-6 mb-3">
                ...
                <select id="frequency" name="frequency" required class="form-select <?php echo isset($errors['frequency']) ? 'is-invalid' : ''; ?>">
                    <option value="one-time" <?php echo (isset($oldInput['frequency']) && $oldInput['frequency'] === 'one-time') ? 'selected' : ''; ?>>One-time</option>
                    <option value="monthly" <?php echo (isset($oldInput['frequency']) && $oldInput['frequency'] === 'monthly') ? 'selected' : ''; ?>>Monthly</option>
                    <option value="quarterly" <?php echo (isset($oldInput['frequency']) && $oldInput['frequency'] === 'quarterly') ? 'selected' : ''; ?>>Quarterly</option>
                    <option value="semi-annual" <?php echo (isset($oldInput['frequency']) && $oldInput['frequency'] === 'semi-annual') ? 'selected' : ''; ?>>Semi-Annual</option>
                    <option value="annual" <?php echo (isset($oldInput['frequency']) && $oldInput['frequency'] === 'annual') ? 'selected' : ''; ?>>Annual</option>
                    <option value="per_term" <?php echo (isset($oldInput['frequency']) && $oldInput['frequency'] === 'per_term') ? 'selected' : ''; ?>>Per Term</option>
                </select>
             ...
             <div class="col-md-6 mb-3">
                ...
                <input type="number" id="due_day" name="due_day" min="1" max="31" placeholder="e.g., 10"
                       value="<?php echo htmlspecialchars($oldInput['due_day'] ?? ''); ?>"
        ...
        <div class="row g-3">
             <div class="col-md-6 mb-3">
                ...
                <select id="late_fee_type" name="late_fee_type" class="form-select <?php echo isset($errors['late_fee_type']) ? 'is-invalid' : ''; ?>">
                    <option value="none" <?php echo (isset($oldInput['late_fee_type']) && $oldInput['late_fee_type'] === 'none') ? 'selected' : ''; ?>>None</option>
                    <option value="fixed" <?php echo (isset($oldInput['late_fee_type']) && $oldInput['late_fee_type'] === 'fixed') ? 'selected' : ''; ?>>Fixed Amount</option>
                    <option value="percentage_per_day" <?php echo (isset($oldInput['late_fee_type']) && $oldInput['late_fee_type'] === 'percentage_per_day') ? 'selected' : ''; ?>>Percentage Per Day</option>
                    <option value="fixed_after_days" <?php echo (isset($oldInput['late_fee_type']) && $oldInput['late_fee_type'] === 'fixed_after_days') ? 'selected' : ''; ?>>Fixed Amount After X Days</option>
                </select>
             ...
             <div class="col-md-6 mb-3">
                 ...
                 <input type="number" id="late_fee_amount" name="late_fee_amount" step="0.01" min="0"
                        value="<?php echo htmlspecialchars($oldInput['late_fee_amount'] ?? '0.00'); ?>"
             ...
             <div class="col-md-6 mb-3">
                 ...
                 <input type="number" id="late_fee_calculation_basis" name="late_fee_calculation_basis" min="0"
                        value="<?php echo htmlspecialchars($oldInput['late_fee_calculation_basis'] ?? '0'); ?>"
    ...
    <div class="mt-3">
        <button type="submit" class="btn btn-success"><i class="bi bi-check-circle"></i> Create Structure</button>
